...
# ==== SHAPES (DATA) ====
# =======================
# Эти функции по-прежнему нужны для обучения SOM (генерация облака точек)
def circle_pts(n):
...
class App:
    ...
    def loop(self):
        ...
        t = min(elapsed / 15.0, 1.0) # 15 секунд на морфинг
    ...
    def start(self):
        ...
        self.reset() # Инициализируем заново перед стартом
        self.running = True
